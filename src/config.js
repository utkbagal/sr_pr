export const companyInfo = {
    ...
    welcomeText: "Welcome to NextGen IT Solutions – Your Digital Transformation Partner",
    services: [
      ...
      { title: "Cybersecurity", description: "Advanced protection for your infrastructure and data." },
